/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2bcd8a036efe3f705433eebd511a481a)
// Runtime types generated with workerd@1.20260405.1 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "RemoveBgContainer";
	}
	interface Env {
		ETHGLOBAL_API_KEY: string;
		REMOVE_BG_CONTAINER: DurableObjectNamespace<import("./index").RemoveBgContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ETHGLOBAL_API_KEY">> {}
}
